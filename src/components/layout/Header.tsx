      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center gap-8">
            <div className="flex items-center gap-4 border-gray-200 dark:border-gray-800">
              <button
                onClick={toggleTheme}
              ...
              <a
                href="mailto:contact@chaochen.com"
                className="px-4 py-2 text-sm font-medium text-white bg-gray-900 hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-900 dark:hover:bg-gray-200 rounded-md transition-all pt-[6px]"
              >
                Contact
              </a>
            </div>
      ...
      {isMenuOpen && (
        <div className="md:hidden border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950">
          <div className="px-4 py-4 space-y-4">
            <a
              href="mailto:contact@chaochen.com"
              className="block w-full text-center px-4 py-2.5 text-base font-medium text-white bg-gray-900 dark:bg-gray-100 dark:text-gray-900 rounded-md"
            >
              Contact
            </a>
          </div>
